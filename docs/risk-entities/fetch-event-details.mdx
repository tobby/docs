...
description: "The Fetch Event Details endpoint lets you retrieve the full payload and decision data for a previously ingested event."
---
...
| --- | --- | --- | --- |
| event_id  | string | Unique identifier assigned or echoed by ProfiledRisk for the evaluated event | required |
