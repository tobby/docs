...
description: "Get the full details of a verification using Reference ID"
---
...
| --- | --- | --- | --- |
| reference_id  | string |  Reference ID of Verification on the [Dashboard](https://app.dojah.io/verifications)  | required |
